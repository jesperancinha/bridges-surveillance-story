...
def send_signal(host, data):
    ...
    connection = pika.BlockingConnection(
        pika.ConnectionParameters(host=host, port=5673, credentials=credentials, virtual_host='bl_train_01_sensor_vh', socket_timeout=5, blocked_connection_timeout=5, stack_timeout=5))
